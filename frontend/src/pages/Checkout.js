        ...
        <div className="lg:col-span-3 bg-white px-5 py-5">
          <form>
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600">
              Choose from existing adderess
            </p>
            <ul role="list">
              {adderesses.map((address) => (
                <li
                  key={address.phone}
                  className="flex justify-between gap-x-6 px-1 py-5 border-solid border-2 border-gray-200"
                >
                  <input
                    id="cash"
                    name="address"
                  ...
                  <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                    ...
                    <p className="mt-1 truncate text-xs leading-5 text-gray-500">
                      City- {address.city} Pincode-{address.pincode} State-
                      {address.state}
                    </p>
                  </div>
                </li>
